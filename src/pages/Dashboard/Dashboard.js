            ...
            <ScrollView>
                <View style={styles.cardCronograma}>
                    ...
                    <View style={{ alignSelf: 'stretch' }}>
                        <Image style={styles.imgCronograma} source={require('../../assets/images/Cronograma.png')}></Image> 
                    </View>
                </View>
                ...
                <View style={styles.cardAgenda}>
                    ...
                    <View style={{ alignSelf: 'stretch' }}>
                        <Image style={styles.imgCronograma} source={require('../../assets/images/agendaEstudo.jpg')}></Image> 
                    </View>
                </View>
            </ScrollView>
        </View>
